...
import com.example.pw_odwsi_project.service.EmailService;
...
public class CustomAuthenticationProvider extends DaoAuthenticationProvider {
    ...
    private final Cache<String, String> lastLoggedIps;
...
//        System.out.println("Login attempt #" + (getCurrentLoginAttempts() + 1) + " of " + authentication.getName());
    ...
    protected Authentication createSuccessAuthentication(Object principal, Authentication authentication, UserDetails user) {
        ...
        checkLoginIpAddress(authentication.getName());
    ...
    private void checkLoginIpAddress(String email) {
        final String currentIp = httpServletRequest.getRemoteAddr();
        final String foundLastIp = lastLoggedIps.get(email, key -> null);

        if (foundLastIp != null) {
            return;
        }

        lastLoggedIps.put(email, currentIp);
        ...
        emailService.sendLoggedInFromAnotherIp(user, currentIp);
    }
